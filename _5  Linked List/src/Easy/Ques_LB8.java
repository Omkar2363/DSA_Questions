...
public class Ques_LB8 {
    ...
    //Ques : Deletion from a Circular Linked List......                                    (GFG Ques.)


    //Approach 1 :                                                                         T.C. = O(n),  S.C. = O(1)
    // Java program to delete a given key from linked list.
    class GFG {
        /* ure for a node */
        static class Node {
            int data;
    ...
    public static void main(String[] args) {
        ...
        /*Ques : In this article, we will learn about deleting a node from a Circular linked list.
