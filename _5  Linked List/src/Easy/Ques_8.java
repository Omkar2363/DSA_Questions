...
public class Ques_8 {
    ...
    //Ques : Sort the biotonic doubly linked list.......                                   (GFG Ques.)
    ...
    /*  Approach : Find the first node in the list which is smaller than its previous node.
                   ...
                   current’s previous node and second starting from current node till the end of the list.
                   Reverse the second doubly linked list. Refer this post. Now merge the first and second
                   sorted doubly linked list.
    * */
    // Java implementation to sort the biotonic doubly linked list
    class GFG {
        ...
        static Node sort(Node head)
        {
            ...
            // split into two lists, one starting with 'head' and other starting with 'current'
    ...
    public static void main(String[] args) {
        ...
        /*Ques : Sort the given biotonic doubly linked list.
                 A biotonic doubly linked list is a doubly linked list which is first increasing
                 and then decreasing. A strictly increasing or a strictly decreasing list is also
                 a biotonic doubly linked list.
