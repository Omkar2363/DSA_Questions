...
public class Ques_S_LB2 {
    ...
    /*  Solution :
         * Use two stacks : one to store actual stack elements and the other as an auxiliary stack to store minimum values.
                            The idea is to do push() and pop() operations in such a way that the top of the auxiliary stack
        ...
        * Let us see an example :-
            ...
            The following is the implementation for SpecialStack class. In the below implementation, SpecialStack
            inherits from Stack and has one Stack object min which works as an auxiliary stack.
    ...
    * */
    ...
    static class SpecialStack extends Stack<Integer> {
        ...
        /* SpecialStack's member method to insert an element to it. This method makes sure that
           the min stack is also updated with appropriate minimum values */
        void push(int x)
        {
            if (isEmpty() == true) {
                super.push(x);
    ...
    * */
    ...
    /*  Space Optimized Version
            ...
            We can push only when the incoming element of the main stack is smaller than or equal to the top of
            the auxiliary stack. Similarly, during pop, if the pop-off element equal to the top of the auxiliary
            stack, remove the top element of the auxiliary stack. Following is the modified implementation of
            push() and pop().

    * */
    // Optimized methods of above solution....
    /*
    ...
    //This method removes top element from min stack also.
    public Integer pop()
    {
        int x = super.pop();
        int y = min.pop();
  ...
  */
    ...
    /*  Complexity Analysis :
            ...
            - Auxiliary Space    : O(n)      The complexity in the worst case is the same as above but in other cases,
                                             it will take slightly less space than the above approach as repetition is
                                             neglected.
    ...
    * */
    ...
    //Approach 3 : Further Optimized Solution.......(S.C. = O(1))
    /* A special stack having peek() pop() and push() along with additional getMin() that returns minimum value
       in a stack without using extra space and all operations in O(1) time.. 🙂 */
    public static class SpecialStack_2 {
        ...
        void push(int val)
        {
            ...
            // demoVal, combine with min and insert into stack
        ...
        {
            SpecialStack_2 s = new SpecialStack_2();
    ...
    * */
    ...
    public static void main(String[] args) {
        ...
        /*Ques : Question: Design a Data Structure SpecialStack that supports all the stack operations like
