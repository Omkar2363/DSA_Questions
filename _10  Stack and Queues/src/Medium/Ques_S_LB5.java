...
public class Ques_S_LB5 {
    ...
    * */
    ...
    /*  An Efficient Solution can solve this problem in O(n) time. The idea is to store indexes of previous
        starting brackets in a stack. The first element of the stack is a special element that provides index
        before the beginning of valid substring (base for next valid string).


        1) Create an empty stack and push -1 to it. The first element of the stack
           is used to provide a base for the next valid string.
        ...
        4) Else (if the character is ')' )
           ...
           b) If the stack is not empty, then find the length of current valid substring
              by taking the difference between the current index and top of the stack.
              If current length is more than the result, then update the result.
    ...
    * */
    ...
    //Approach 3 : Another Efficient Solution.........
    /*  Another Efficient Approach can solve the problem in O(n) time.

        The idea is to maintain an array that stores the length of the longest valid substring ending
        at that index. We iterate through the array and return the maximum value.
    ...
    * */
    ...
    class GFG {
        static int findMaxLen(String s)
        {
            ...
            for (int i = 1; i < s.length(); i++)
            {
                ...
                {
                    longest[i] =  longest[i - 1] + 2 + ((i - longest[i - 1] - 2 >= 0)  ?  longest[i - longest[i - 1] - 2]
                                                                                       : 0);
    ...
    //Another 4 : Another Efficient Solution.......
    /*  Another approach in O(1) auxiliary space and O(N) Time complexity :

            1. The idea to solve this problem is to traverse the string on and keep track of the count
               of open parentheses and close parentheses with the help of two counters left and right respectively.
            ...
            3. Whenever the left becomes equal to right, the length of the current valid string is calculated
               and if it greater than the current longest substring, then value of required the longest substring is
               updated with current string length.
    ...
    * */
    ...
    class GFG_4 {
        ...
        public static int solve(String s, int n)
        {
            ...
            // Variables for left and right counter maxlength to store
            ...
            for (int i = 0; i < n; i++) {
                ...
                // If "(" is encountered, then left counter is incremented
    ...
    public static void main(String[] args) {
        ...
        /*Ques : Given a string consisting of opening and closing parenthesis, find the length of
