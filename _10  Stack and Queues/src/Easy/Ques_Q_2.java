...
public class Ques_Q_2 {
    ...
    //Ques : Implement Stack and Queue using Deque...........                            (GFG Ques.)
    ...
    class GFG{
        ...
        {
            int value;
            Ques_S_4.GFG.DQueNode next;
            Ques_S_4.GFG.DQueNode prev;
        }
        ...
        static class deque
        {
            ...
            private Ques_S_4.GFG.DQueNode head;
            private Ques_S_4.GFG.DQueNode tail;
            ...
            int size()
            {
                ...
                if (!isEmpty())
                {
                    Ques_S_4.GFG.DQueNode temp = head;
                    int len = 0;
            ...
            void insert_first(int element)
            {
                ...
                Ques_S_4.GFG.DQueNode temp = new Ques_S_4.GFG.DQueNode();
                temp.value = element;
            ...
            void remove_last()
            {
                ...
                if (!isEmpty())
                {
                    Ques_S_4.GFG.DQueNode temp = tail;
                    tail = tail.prev;
                    if(tail!=null)
                    {
                        tail.next = null;
        ...
        static class Stack
        {
            Ques_S_4.GFG.deque d = new Ques_S_4.GFG.deque();
        ...
        public static void main_1(String[] args)
        {
            ...
            // Object of Stack
            Ques_S_4.GFG.Stack stk = new Ques_S_4.GFG.Stack();
            ...
            // Object of Queue
            Ques_S_4.GFG.Queue que = new Ques_S_4.GFG.Queue();
    ...
    public static void main(String[] args) {
        ...
        /*Ques : Deque also known as double ended queue, as name suggests is a special kind of queue
                 in which insertions and deletions can be done at the last as well as at the beginning.

                 A link-list representation of deque is such that each node points to the next node as well as
                 the previous node. So that insertion and deletions take constant time at both the beginning and the last.
