...
public class Ques_7 {
    ...
    public class Main {
        ...
        static Main.Node newNode(int data)
        {
            Main.Node node = new Main.Node(data);
            return node;
        }

        // Function to print the zigzag traversal
        static Vector<Integer> zigZagTraversal(Main.Node root)
        {
    ...
    public class Main_3 {
        ...
        // A utility function to create a new node
        static Main_3.Node newNode(int data)
        {
            Main_3.Node node = new Main_3.Node(data);
            return node;
        }

        // Function to print the zigzag traversal
        static ArrayList<Integer> zigZagTraversal(Main_3.Node root)
        {
            ...
            Queue<Main_3.Node> q = new LinkedList<Main_3.Node>();
            q.add(root);
