...
public class Ques_LB_3 {
    ...
    //Approach 1 :
    /*  [Method 1] :
            A simple solution is that, we pick every node of tree and try to find is any subtree of given tree is
            present in tree which is identical with that sub-tree. Here we can use below post to find if a subtree
            is present anywhere else in tree.
    *
    *
    * */
    ...
    /*  [Method 2 ] : ( Efficient solution )
            ...
            subtrees as strings and store the strings in hash table. Once we find a serialized tree
