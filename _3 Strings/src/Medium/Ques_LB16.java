...
public class Ques_LB16 {

    //Ques : Recursively print all sentences that can be formed from list of word lists            (GFG Ques)
    ...
    class GFG {
        ...
        /*
         A recursive function to print all possible sentences
         that can be formed from a list of word list
        */
    ...
    public static void main(String[] args) {
        ...
        /*Ques : Given a list of word lists How to print all sentences possible taking one word
