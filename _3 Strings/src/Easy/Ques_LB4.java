...
public class Ques_LB4 {
    ...
    //Ques : Java Program to Check if a string is a valid shuffle of two distinct strings...            ()


    //Approach 1 :
    /*  Code : Complete code is in separate class.
    ...
    */
    class Test {
        ...
        // this method converts the string to char array, sorts the char array
    ...
    public static void main(String[] args) {
        ...
        /*Ques : Follow the link for more details :
