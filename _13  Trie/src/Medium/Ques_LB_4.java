...
public class Ques_LB_4 {
    ...
    class Solution {
        public List<List<String>> Anagrams(String[] string_list) {
            ...
            for(String i: string_list)
            {
                ...
                Arrays.sort(ch);
                // Convert the string to its lexicographically least representation,
                // e.g. cat->act, act->act, tac->act
                String str = String.valueOf(ch);

                // Check if that representation has occurred already
                ...
                else
                {
                    ...
                    // Insert into the map the string as key and the new list as value
                    map.put(str,list);
                }
            }
    ...
    /* Complexity Analysis :
          * Time Complexity : O(MN + N*MlogM) time where,  N = Number of strings
                                                           M = Length of the largest string

                              Inserting all the words in the trie takes O(MN) time and sorting
                              the buffer takes O(N*MlogM) time
    ...
    * */
    ...
    //C++ Code....
    /*  C++ program for finding all anagram pairs in the given array
        #include <algorithm>
        #include <iostream>
    ...
    * */
    ...
    /*  Complexity Analysis :
           ...
           * Space Complexity : O(n)              There are n words in a string.
                                                  The map requires O(n) space to store the strings.
    ...
    * */
    ...
    public static void main(String[] args) {
        ...
        /*Ques : Given an array of strings, return all groups of strings that are anagrams. The groups must be created
            ...
            Output  : act cat tac
                      god dog
            Explanation : There are 2 groups of anagrams :
