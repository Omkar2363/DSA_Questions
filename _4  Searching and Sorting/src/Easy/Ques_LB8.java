...
public class Ques_LB8 {
    ...
    //Ques : Arithmetic Number....                                                           (GFG Ques.)
    ...
    public static void main(String[] args) {
        ...
        /*Ques : Given three integers  'A' denoting the first term of an arithmetic sequence ,
            ...
            Input   : A = 1, B = 3, C = 2
            Output  : 1
            Explanation : 3 is the second term of the sequence starting with 1 and having a common
                          difference 2.
